...
/**
 * The Block class represents a single pixel in the original image. A rigid body is made up of a
...
public class Block {
  ...
  static double radius =
      Math.sqrt(2) * 0.5; // * 0.9; // 90% of the normal size... allow for some overlap?
  ...
  /**
   * Computes a mass based on the intensity, darker is heavier. Uses standard colour to intensity
   * conversion weights.
   *
