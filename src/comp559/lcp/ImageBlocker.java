...
public class ImageBlocker {
  ...
  /**
   * Searches for all pixels connected to given block using grass fire. Uses a queue rather than
   * recursion to avoid stack overflow in large images
   */
  private void searchConnected(
      int x, int y, ArrayList<Block> blocks, ArrayList<Block> boundaryBlocks) {
  ...
  /**
   * Checks if this block is on the boundary. Boundary blocks have at least one white neighbour.
   *
   * @param x
   * @param y
