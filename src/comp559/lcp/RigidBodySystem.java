...
/**
 * Maintains a list of RigidBody objects, and provides methods for collision processing and
...
public class RigidBodySystem {
  ...
  private BooleanParameter drawBoundingVolumes =
      new BooleanParameter("draw root bounding volumes", false);
  private BooleanParameter drawAllBoundingVolumes =
      new BooleanParameter("draw ALL bounding volumes", false);
  private BooleanParameter drawBoundingVolumesUsed =
      new BooleanParameter("draw bounding volumes used", false);
  ...
  public void display(GLAutoDrawable drawable) {
    ...
    if (Block.alpha != (float) (double) transparency.getValue()) {
      ...
      // which is potentially slow and bad news (memory thrashing) for openGL if we do this
      // excessively!
