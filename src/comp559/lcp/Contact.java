...
public class Contact {
   ...
   */
  public static int nextContactIndex = 0;
  ...
  public Contact(RigidBody body1, RigidBody body2, Point2d contactW, Vector2d normal) {
    ...
    jacobianRowOne =
        new double[] {
          -normal.x,
          -normal.y,
          body1ToContact.y * normal.x - body1ToContact.x * normal.y,
          normal.x,
          normal.y,
          body2ToContact.x * normal.y - body2ToContact.y * normal.x
        };
    jacobianRowTwo =
        new double[] {
          -tangent.x,
          -tangent.y,
          body1ToContact.y * tangent.x - body1ToContact.x * tangent.y,
          tangent.x,
          tangent.y,
          body2ToContact.x * tangent.y - body2ToContact.y * tangent.x
        };
  ...
  /**
   * Draws the connections between bodies to visualize the the adjacency structure of the matrix as
   * a graph.
   *
   * @param drawable
   */
